...
def LowAge(x):
    if x <= 25: return 1
    else: return mf(x,15,22.5,27.5,35)
def MidAge(x):
    return mf(x,25,37.5,42.5,55)
def HighAge(x):
    if x >= 60: return 1
    else: return mf(x,40,57.5,62.5,80)

# Height
def LowHei(x):
    if x <= 140: return 1
    else: return mf(x,120,135,145,160)
def MidHei(x):
    return mf(x,150,157,163,170)
def HighHei(x):
    if x >= 180: return 1
    else: return mf(x,165,175,185,195)

# Weight
def LowWei(x):
    if x <= 40: return 1
    else: return mf(x,25,38,42,55)
def MidWei(x):
    return mf(x,50,62,68,80)
def HighWei(x):
    if x >= 90: return 1
    else: return mf(x,75,87,93,105)

# Systole
def LowSys(x):
    if x <= 90: return 1
    else: return mf(x,80,87,93,100)
def MidSys(x):
    return mf(x,85,102,108,125)
def HighSys(x):
    if x >= 135: return 1
    else: return mf(x,110,132,138,150)

# Diastole
def LowDia(x):
    if x <= 55: return 1
    else: return mf(x,45,52,58,65)
def MidDia(x):
    return mf(x,55,67,73,85)
def HighDia(x):
    if x >= 85: return 1
    else: return mf(x,75,83,87,100)
...
def HighCho(x):
    if x >= 3: return 1
    else: return mf(x,1.5,2.75,3.25,4.5)
...
model.save_weights("trapmf_model.h5")
